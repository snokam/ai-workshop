...
/**
 * A claim, as task 1 knows it: what was reported, and what has to arrive before anyone can decide.
 *
 ...
 * because reading the photo is task 2's job. That question lives in task 2, on ClaimDocuments, and
 * this record stays answerable by a participant who has only written the first agent.
 */
public record Claim(String id, String reference, ClaimType type, List<String> requiredDocuments) {}
