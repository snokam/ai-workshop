 ...
 * empty. Constraining {@link #scenario} to the {@link ClaimScenario} enum is what stops the agent
 ...
 * @param scenario the scenario the claim is opened as; null unless deciding
...
public record InterviewTurn(
        ...
        @Description("The scenario the description best fits. Null unless DECIDED.") ClaimScenario scenario,
