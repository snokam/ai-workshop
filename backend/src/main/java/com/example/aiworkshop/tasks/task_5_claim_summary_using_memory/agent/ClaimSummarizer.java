...
import com.example.aiworkshop.tasks.task_5_claim_summary_using_memory.DocumentForSummary;
...
public interface ClaimSummarizer {
    ...
    @SystemMessage(
            ...
            You may have summarised this claim before. When you have, the handler has already read
            that summary and does not want it again — lead with what is new since, and say plainly if
            something that arrived contradicts what was already there. When you have not, write the
            whole thing.

            Whatever you were told last time, the documents you are shown now are the truth. Never repeat a
            figure or a date from an earlier summary that is not in front of you.
            """)
    @UserMessage(
            """
