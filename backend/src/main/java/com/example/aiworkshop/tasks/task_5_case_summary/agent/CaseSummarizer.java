package com.example.aiworkshop.tasks.task_5_case_summary.agent;

import com.example.aiworkshop.tasks.task_5_case_summary.DocumentForSummary;
...
public interface CaseSummarizer {
    ...
    @SystemMessage("TODO — task 5. Write the system message for the summariser.")
    @UserMessage(
            """
            Case type: {{caseType}}
