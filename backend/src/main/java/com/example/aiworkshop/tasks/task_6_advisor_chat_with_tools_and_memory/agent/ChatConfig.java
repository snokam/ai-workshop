...
public class ChatConfig {
    ...
    public static ChatMemoryProvider claimConversations() {
        // Built inside the lambda, so each claim id gets a memory of its own. One instance created
        // outside and handed to everybody compiles, starts, and is perfect until a second claim is
        // opened — at which point a handler is reading somebody else's conversation, fluently and
        // without an error anywhere.
        //
        // Twenty messages, and a message is not a turn: the opening user message carries the whole
        // claim at a glance, and every tool call and every tool result is a message too. A question
        // that reads two documents can spend five of the twenty on its own. Twenty is roughly four
        // exchanges of real work, which is about as far back as a handler refers.
