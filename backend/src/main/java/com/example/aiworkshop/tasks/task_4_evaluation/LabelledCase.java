...
public record LabelledCase(String description, CaseType expected, String why) {
    ...
    public static List<LabelledCase> yours() {
        // TODO — task 4, part 1. Add the cases you would argue about.
        //
        // Return a List.of(new LabelledCase(description, expectedType, why), ...). Seven or eight on top
        ...
        //
        // expectedType may be null. There is no case type for "something else", so "my neighbour parks
