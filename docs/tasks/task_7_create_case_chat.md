# Task 7 — Case: File claim with AI chat
...
The parts, in order, are in `backend/src/main/java/com/example/aiworkshop/tasks/task_7_create_case_chat/README.md` — each one names the file, what it is for, and what to reach for.
