...
[task 3](./tasks/task_2_guardrails.md) and [task 4](./tasks/task_5_fraud_detection.md).
...
The other checks in `tasks/task_5_fraud_detection/checks/` are the same shape: EXIF says an image came
...
[task 4](./tasks/task_5_fraud_detection.md) for the one check that was left out for exactly that
reason.
